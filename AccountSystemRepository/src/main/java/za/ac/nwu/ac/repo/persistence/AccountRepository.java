...
//    Account getAccountTypeByAccNum(Integer accountNumber);
    ...
    @Query(value = "SELECT a.balance FROM Account a WHERE a.accountNumber = :accountNumber AND a.type = :type")
    Double getBalanceByAccNum(Integer accountNumber, String type);
